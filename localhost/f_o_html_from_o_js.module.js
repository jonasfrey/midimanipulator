            ...
            try {
                ...
                if(o_js?.o_jsh?.b_render === false){
                    ...
                    for(let v of a_v_resolved){
                        ...
                        if(v){
                            let v2 = v;
                            let o_html2 = o_js._o_html;
                            if(v2._raw){
                                v2 = v2._raw
                            }
                            if(o_html2._raw){
                                o_html2 = o_html2._raw
                            }
                            o_html2.appendChild(
                                v2
                            )
                ...
                o_js._f_render = async function(){
                    ...
                    try {
                        ...
                        let o_html_old2 = o_html_old;
                        if(o_html_old2._raw){
                            o_html_old2 = o_html_old2._raw;
                        }
                        let v_o_html2 = v_o_html;
                        if(v_o_html2._raw){
                            v_o_html2 = v_o_html2._raw;
                        }
                        o_html_old2.parentElement.replaceChild(
                            v_o_html2,
                            o_html_old2,
                        )
                        if(typeof o_js.f_after_f_o_html__and_make_renderable == 'function'){
